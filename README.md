...
- **強さを段階的に選べる対戦 AI** — 初心者が気持ちよく勝てる弱さから、まず勝てない最強格まで、相手の手応えを選んで対局できる。
...
API キーや環境変数は不要。インストール後すぐに、メニューから対戦・検討の両モードが動く。
...
npm run bench:ab     # 評価関数の新旧を自己対戦させ勝率を比較
